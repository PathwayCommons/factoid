...
$(function(){
  ...
  $(document)
      ...
      ui.maintainScrollTop( $entity.attr('id'), $('body'), function(){
        doc.toggleEdit( id, function( shown ){
          if( shown ){
            ...
            if( doc.entityIsAssociated( id ) ){
              doc.loadAssociatedInfoForEntity( id );
    ...
    .on('focus', '#entities-list input, #entities-list textarea', function(){
      var id = $(this).attr('data-id');

      cy.getElementById(id).addClass('focus');
    })

    .on('blur', '#entities-list input, #entities-list textarea', function(){
      var id = $(this).attr('data-id');

      cy.getElementById(id).removeClass('focus');
    })
