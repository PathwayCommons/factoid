...
function startTour(){
  ...
  $('html').tourguide({
    beforeShow: function(){
      doc.hideTextmining();
      $('#textmining-input .buttons .add').trigger('tap');
    },
    modalTarget: '#info',
    my: 'right center',
    at: 'left center',
    content: 'After adding the text to the document, the entities and interactions found are added here.' + buttons + skipText
  });
