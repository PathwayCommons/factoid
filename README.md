...
- `INDRA_STATEMENTS_URL`: url for getting the indra statements between genes
- `INDRA_ENGLISH_ASSEMBLER_URL`: url for assembling english sentences from indra statements
