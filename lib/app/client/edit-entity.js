$(function(){
  ...
  $('html').on('tap', '.disassociate .active-area', function(){
    var $disassoc = $(this);
  ...
  $('html').on('tap', '.associate-button', function(){
    var $button = $(this);
  ...
  $('html').on('keydown', '.associate-button', function(e){
    var $button = $(this);
    var id = $button.parents('.associations:first').attr('data-entity-id');
    var index = $button.attr('data-index');
  ...
  var id2prevName = {};
  $('html').on('keydown keyup keypress', '.edit-name-input', _.debounce(function(){
    var $input = $(this);
    var name = $input.val();
