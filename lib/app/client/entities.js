...
$(function(){
  ...
  $('html')
    ...
    .on('tap', '.delete-all', function(e){ 
      doc.removeAllEntities();
    })

    // remove entity when clicking the remove icon
    .on('tap', '#entities-list .entity-instance > .icons > .remove', function(e){ 
      var $icon = $(this);
    ...
    .on('tap', '#entities-list .entity-instance > .edit', function(){
      var $this = $(this);
    ...
    .on('tap', '#entities-list .interaction .name', function(){
    ...
    .on('tap', '#entities-list .entity-instance > .icons > .add-participants', function(){
      var $icon = $(this);
      var $entity = $icon.parents('.entity-instance:first');
      var id = $entity.attr('data-id');
    ...
    .on('tap', '#entities-list .participant > .icons > .remove', function(){
      var $icon = $(this);
  ...
  $('html').on('tap', '#entities-list .add-participants-list .add-participant', function(){
    var $button = $(this);
