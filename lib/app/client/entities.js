...
$(function(){
  ...
  $('#entities-list')
    ...
    .on('click', '.entity-instance > .edit', function(){
      ...
      var entityIsInteraction = $entity.hasClass('interaction');
      var isAssociated = $entity.hasClass('associated-true');
      var showMatches = !entityIsInteraction;

      $icon.showqtip({
        style: {
          classes: 'edit-entity-qtip'
        },
        content: {
          //title: isAssociated ? 'Specify entity' : undefined,
          text: isAssociated ? ui.associatedInfoFor( entityId ) : ui.editNameFor( entityId, showMatches )
        }
      });
    })
