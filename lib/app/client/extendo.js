...
$(function(){
  ...
  $('html').extendo({
    ...
    items: [
      ...
      {
        content: '<span class="delete-all"><span class="label">Delete all </span><span class="icon-1 icon-remove"></span><span class="icon-2 icon-remove"></span><span class="icon-3 icon-remove"></span></span>',
        disabled: true,
        attrs: {
