...
$(function(){
  ...
  $('body').extendo({
    ...
    items: [
      {
        content: '<span class="icon-plus" data-tooltip="Add entity"></span>',
        select: function(){
      ...
      {
        content: '<span class="icon-remove" data-tooltip="Remove entity"></span>',
        disabled: true,
        attrs: {
          id: 'extendo-remove'
        },
      ...
      {
        content: '<span class="icon-refresh" data-tooltip="Auto-rearrange entities"></span>',
        attrs: {
          id: 'extendo-layout'
        },
        select: function(){
      ...
      {
        content: '<span class="icon-download-alt" data-tooltip="Download document as SIF"></span>',
        select: function(){
          doc.exportAsSif();
        }
      },
      ...
      {
        content: '<span class="icon-info-sign" data-tooltip="About Factoid"></span>',
        attrs: {
          id: 'extendo-info'
        },
        select: function(){
          ...
          if( $lastInfoQtip && $lastInfoQtip.is(':visible') ){
            ...
            $('#extendo-info').showqtip({
              content: {
                ...
                text: $('#description-content').derbyClone()
              },
      ...
      {
        content: '<a target="_blank" href="https://github.com/PathwayCommons/factoid"><span class="icon-github" data-tooltip="Open project on GitHub"></span></a>'
      }
    ]
  });
