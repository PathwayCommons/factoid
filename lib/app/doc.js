  ...
  */
  ...
  return {
    ...
    toggleAddParticipants: function( interactionId, next ){
      togglePopover( model.at('entities').at(interactionId), '_showAddParticipants', '_showAddParticipantsAnimated', next );
    },
    ...
    getAssociatedEntitiesFromQuery: function(entityId, query, ok ){
      ...
      model.set('entities.' + entityId + '._loadingPotentialAssociations', true);

      textmining.getAssociatedEntitiesFromQuery(query, function(err, entities){
        if( ok() ){
          model.set('entities.' + entityId + '._loadingPotentialAssociations', false);
