...
module.exports = function( model ){
  ...
  */
  ...
  return {
    ...
    //
    // .associateEntity( function(entId, db, dbId, name){} ) : listens to when an entity
    // is associated with a db
    associateEntity: function( entityId, db, dbId, name ){
      var fn = arguments[0];

      if( isFunction(fn) ){
        // TODO revise how we store association the model s.t. we can listen to it easier
