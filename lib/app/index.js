...
get('/', function(page, model, params) {
  ...
  return model.subscribe(docPath, 'entities', function(err, doc, entities){
    ...
    function generatePopulatedEntities(entities){
      var popd = [];
    ...
    model.fn('_populatedEntities', '_entities', generatePopulatedEntities);

    model.fn('_populatedTextminingEntities', '_textminingEntities', generatePopulatedEntities);
