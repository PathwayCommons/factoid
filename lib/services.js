...
module.exports = function(_, http, port, request, form, nodemailer){
  ...
  function userFeedback( text, next ){
    ...
    var message = {
        ...
        // sender info
        from: 'Factoid mailer <factoid.mailer@gmail.com>',

        // Comma separated list of recipients
        to: '"Factoid developers" <pathway-commons-dev@googlegroups.com>',

        // Subject of the message
        subject: '[factoid-feedback] ' + text.substring(0, 32) + '...',
