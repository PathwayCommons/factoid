...
class ActivationInhibitionForm extends InteractionForm{
  ...
  render(){
    ...
    return h('div.form-interaction', [
      h(EntityForm, { entity: lEnt , placeholder: 'Source protein', document: this.data.document, bus: this.data.bus}),
      ...
      h(EntityForm, { entity: rEnt, placeholder: 'Target protein' , document: this.data.document, bus: this.data.bus} ),
    ]);
