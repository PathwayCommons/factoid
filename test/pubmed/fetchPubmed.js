...
const TEST_PUBMED_DATA = new Map([
  ...
  // ,['30115697', 'pmid_30115697.xml']
  // ,['30078747', 'pmid_30078747.xml']
]);


describe('fetchPubmed', function(){

  for( const [ pmid, xmlfile ] of TEST_PUBMED_DATA.entries() ) {
    ...
    describe('pubmedDataConverter', function(){
      ...
      before( () => {
        ...
        const jsonData = convert.xml2json( xml, { compact: true, spaces: 2 } );
        pubmedInfo = pubmedDataConverter( JSON.parse( jsonData ) );
      });
